...
if __name__ == "__main__":
    ...
    # plt.tight_layout()
    # output_path = "/Users/jeffreyzweidler/Desktop/Semester_Project/AlpsCropFormer/plots/class_distribution_pastis.png"
    ...
    # Separate void label (class 31) from other classes
    void_class_id = 31
    void_count = swiss_pixel_counts.pop(void_class_id, 0)
    ...
    # Add "Other" category if there are minor classes
    if other_total > 0:
        swiss_sorted_classes.append('Other')
        swiss_sorted_counts.append(int(other_total))
        swiss_sorted_names.append('Other')
    
    # Add void label at the very end if it exists
    if void_count > 0:
        swiss_sorted_classes.append(void_class_id)
        swiss_sorted_counts.append(int(void_count))
        swiss_sorted_names.append(swiss_class_names.get(void_class_id, f'Class {void_class_id}'))
    ...
    plt.title('Class distribution in CropMapsSwiterland_v1 dataset', fontsize=16, fontweight='bold')
    ...
    plt.tight_layout()
    output_path = "/Users/jeffreyzweidler/Desktop/Semester_Project/AlpsCropFormer/plots/class_distribution_swiss.png"
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    plt.show()
    ...
    for i, class_id in enumerate(swiss_sorted_classes):
        ...
        elif class_id == void_class_id:
            class_name = swiss_class_names.get(class_id, f'Class {class_id}')
            print(f"Class {class_id} ({class_name}): {void_count:,.0f} pixels")
        else:
            class_name = swiss_class_names.get(class_id, f'Class {class_id}')
